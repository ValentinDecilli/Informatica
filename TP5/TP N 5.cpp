...
int main() {
	...
	//Crear una funci�n que devuelva el valor a pagar de una compra con descuento, introduciendo el precio (valor) de la compra y el descuento en porcentaje que se realiza.
